...
- [README.md](Anti-patterns for joins\README.md) <!-- score: 3.805 | shared: analysis, anti, book, common, comprehensive -->
- [README.md](Join type selection logic\README.md) <!-- score: 3.782 | shared: analysis, anti, based, common, comprehensive -->
- [README.md](Join order rules\README.md) <!-- score: 3.671 | shared: algorithms, anti, based, common, comprehensive -->
- [README.md](Extract-only joins\README.md) <!-- score: 3.658 | shared: anti, business, common, conceptual, constraints -->
- [README.md](Join condition testing\README.md) <!-- score: 3.656 | shared: analysis, anti, common, conceptual, constraints -->
