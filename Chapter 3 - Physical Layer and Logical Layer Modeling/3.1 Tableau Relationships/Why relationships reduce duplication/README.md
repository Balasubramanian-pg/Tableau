...
- [README.md](..\Multiple relationships between tables\README.md) <!-- score: 3.932 | shared: anti, between, book, common, comprehensive -->
- [README.md](..\Cardinality settings\README.md) <!-- score: 3.755 | shared: anti, being, between, book, common -->
- [README.md](..\Understanding many-to-many performance\README.md) <!-- score: 3.739 | shared: anti, between, common, concepts, conceptual -->
- [README.md](..\Performance benefits of relationships\README.md) <!-- score: 3.701 | shared: anti, between, common, comprehensive, conceptual -->
- [README.md](..\Relationship-driven aggregation mismatches\README.md) <!-- score: 3.679 | shared: anti, being, between, common, comprehensive -->
