...
- [README.md](..\Understanding many-to-many performance\README.md) <!-- score: 4.000 | shared: anti, between, cases, common, concepts -->
- [README.md](..\Relationship-driven aggregation mismatches\README.md) <!-- score: 3.813 | shared: anti, between, cases, common, concept -->
- [README.md](..\Multiple relationships between tables\README.md) <!-- score: 3.711 | shared: anti, attributes, based, between, common -->
- [README.md](..\Identity fields in relationships\README.md) <!-- score: 3.670 | shared: anti, attributes, between, cases, common -->
- [README.md](..\Logical table architecture\README.md) <!-- score: 3.646 | shared: anti, attributes, cases, common, concepts -->
