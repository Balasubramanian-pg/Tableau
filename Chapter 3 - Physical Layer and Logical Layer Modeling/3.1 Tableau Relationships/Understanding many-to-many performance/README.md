...
- [README.md](..\Relationship vs join difference\README.md) <!-- score: 3.984 | shared: anti, between, cases, common, concepts -->
- [README.md](..\Relationship-driven aggregation mismatches\README.md) <!-- score: 3.813 | shared: anti, between, cases, common, concepts -->
- [README.md](..\Identity fields in relationships\README.md) <!-- score: 3.804 | shared: anti, between, cases, common, complex -->
- [README.md](..\Why relationships reduce duplication\README.md) <!-- score: 3.728 | shared: anti, between, common, concepts, conceptual -->
- [README.md](..\Multiple relationships between tables\README.md) <!-- score: 3.711 | shared: anti, between, common, complex, concepts -->
