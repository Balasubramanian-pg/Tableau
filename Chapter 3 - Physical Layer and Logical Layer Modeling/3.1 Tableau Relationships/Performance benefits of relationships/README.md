...
- [README.md](..\Why relationships reduce duplication\README.md) <!-- score: 3.728 | shared: anti, between, common, comprehensive, conceptual -->
- [README.md](..\Understanding many-to-many performance\README.md) <!-- score: 3.694 | shared: anti, between, cases, common, conceptual -->
- [README.md](..\Multiple relationships between tables\README.md) <!-- score: 3.619 | shared: anti, between, common, comprehensive, conceptual -->
- [README.md](..\Logical table architecture\README.md) <!-- score: 3.600 | shared: anti, cases, common, comprehensive, conceptual -->
- [README.md](..\Relationship vs join difference\README.md) <!-- score: 3.539 | shared: anti, between, cases, common, conceptual -->
