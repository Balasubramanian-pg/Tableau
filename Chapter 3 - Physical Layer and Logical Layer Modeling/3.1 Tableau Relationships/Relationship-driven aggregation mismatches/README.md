...
- [README.md](..\Cardinality settings\README.md) <!-- score: 3.843 | shared: anti, arise, being, between, cases -->
- [README.md](..\Understanding many-to-many performance\README.md) <!-- score: 3.828 | shared: anti, between, cases, common, concepts -->
- [README.md](..\Relationship vs join difference\README.md) <!-- score: 3.812 | shared: anti, between, cases, common, concept -->
- [README.md](..\Why relationships reduce duplication\README.md) <!-- score: 3.683 | shared: anti, being, between, common, comprehensive -->
- [README.md](..\Granularity drift in relationships\README.md) <!-- score: 3.660 | shared: anti, being, between, cases, common -->
