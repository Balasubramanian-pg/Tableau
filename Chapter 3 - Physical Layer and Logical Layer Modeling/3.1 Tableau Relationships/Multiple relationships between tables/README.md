...
- [README.md](..\Why relationships reduce duplication\README.md) <!-- score: 3.904 | shared: anti, between, book, common, comprehensive -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.2 FIXED LOD Patterns\FIXED for multi-fact models\README.md) <!-- score: 3.900 | shared: anti, between, business, common, concepts -->
- [README.md](..\Identity fields in relationships\README.md) <!-- score: 3.891 | shared: another, anti, attributes, between, common -->
- [README.md](..\Logical table architecture\README.md) <!-- score: 3.870 | shared: anti, attributes, book, common, comprehensive -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.3 INCLUDE LOD Patterns\INCLUDE vs nested table calculations\README.md) <!-- score: 3.833 | shared: anti, based, between, common, complex -->
