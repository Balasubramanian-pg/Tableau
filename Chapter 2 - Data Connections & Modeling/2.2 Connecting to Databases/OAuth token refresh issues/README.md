...
- [README.md](..\Session parameter management\README.md) <!-- score: 3.594 | shared: access, anti, applied, authentication, authorization -->
- [README.md](..\Publishing with embedded credentials\README.md) <!-- score: 3.535 | shared: access, anti, authentication, authorization, common -->
- [README.md](..\SSL connections\README.md) <!-- score: 3.474 | shared: anti, applied, client, common, conceptual -->
- [README.md](..\README.md) <!-- score: 3.450 | shared: addressed, anti, application, common, conceptual -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.3 INCLUDE LOD Patterns\INCLUDE with dimensions vs measures\README.md) <!-- score: 3.410 | shared: anti, common, conceptual, constraints, definitions -->
