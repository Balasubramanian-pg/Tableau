...
- [README.md](..\2.2 Connecting to Databases\README.md) <!-- score: 3.546 | shared: addressed, anti, application, applications, cases -->
- [README.md](..\2.2 Connecting to Databases\Initial SQL usage\README.md) <!-- score: 3.340 | shared: anti, application, common, comprehensive, conceptual -->
- [README.md](Working with TSV\README.md) <!-- score: 3.262 | shared: anti, cases, common, comprehensive, conceptual -->
- [README.md](Data interpreter behaviors\README.md) <!-- score: 3.246 | shared: anti, application, cases, common, comprehensive -->
- [README.md](Refreshing Excel data\README.md) <!-- score: 3.244 | shared: addressed, anti, cases, common, conceptual -->
