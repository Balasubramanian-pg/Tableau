...
- [Practice Schedule.md](Practice Schedule.md) <!-- score: 3.460 | shared: advanced, behavior, build, charts, clean -->
- [README.md](README.md) <!-- score: 3.066 | shared: actions, behavior, chapter, chart, charts -->
- [Readme.md](Chapter 14 - Automations In Tableau\Tableau Desktop\Readme.md) <!-- score: 2.121 | shared: calculation, clean, color, custom, dashboard -->
- [README.md](Chapter 1 - Tableau Foundations\1.1 Tableau’s Identity\Tableau as a visual-first computation engine\README.md) <!-- score: 1.989 | shared: api, dimensions, every, fields, into -->
- [README.md](Chapter 1 - Tableau Foundations\1.1 Tableau’s Identity\How Tableau abstracts SQL for analysts\README.md) <!-- score: 1.986 | shared: dimensions, fields, into, join, joins -->
