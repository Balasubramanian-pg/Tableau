...
- [README.md](..\Content governance\README.md) <!-- score: 2.554 | shared: access, active, admin, archival, business -->
- [README.md](..\Audit and compliance requirements\README.md) <!-- score: 2.509 | shared: access, actions, admin, analysis, based -->
- [README.md](..\Admin views\README.md) <!-- score: 2.267 | shared: access, active, admin, check, cloud -->
- [README.md](..\Certified data sources workflow\README.md) <!-- score: 2.176 | shared: business, catalog, clear, cloud, contact -->
- [Readme.md](..\..\..\Chapter 14 - Automations In Tableau\Readme.md) <!-- score: 2.038 | shared: analysis, archive, based, check, content -->
