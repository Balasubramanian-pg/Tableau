...
- [1. RLS Via User Groups.md](..\Group-based access control\1. RLS Via User Groups.md) <!-- score: 2.061 | shared: dashboard, executive, filters, group, logic -->
- [1. Arranging Co-ordinates Across Workbooks.md](..\..\..\Chapter 14 - Automations In Tableau\1. Arranging Co-ordinates Across Workbooks.md) <!-- score: 1.931 | shared: dashboard, dashboards, every, exactly, here -->
- [Practice Schedule.md](..\..\..\Practice Schedule.md) <!-- score: 1.750 | shared: basic, dashboard, dashboards, flow, logic -->
- [2. Dynamic RLS Using USERNAME().md](..\Group-based access control\2. Dynamic RLS Using USERNAME().md) <!-- score: 1.658 | shared: exactly, filters, logic, objective, only -->
- [README.md](README.md) <!-- score: 1.490 | shared: dashboards, group, key, like, shows -->
