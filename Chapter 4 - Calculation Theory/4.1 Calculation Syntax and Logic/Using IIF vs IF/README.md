...
- [README.md](..\Boolean logic as filtering\README.md) <!-- score: 3.637 | shared: algebra, anti, avoid, based, boolean -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.3 INCLUDE LOD Patterns\INCLUDE for cross-row comparisons\README.md) <!-- score: 3.478 | shared: analysis, anti, common, complex, components -->
- [README.md](..\Nested logical expressions\README.md) <!-- score: 3.439 | shared: algebra, anti, boolean, clear, code -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.3 INCLUDE LOD Patterns\INCLUDE vs nested table calculations\README.md) <!-- score: 3.367 | shared: analysis, anti, based, between, calculations -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.3 INCLUDE LOD Patterns\INCLUDE with dimensions vs measures\README.md) <!-- score: 3.361 | shared: analysis, anti, common, components, conceptual -->
