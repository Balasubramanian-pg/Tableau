...
- [README.md](..\..\..\Chapter 2 - Data Connections & Modeling\2.1 Connecting to Files\Working with TSV\README.md) <!-- score: 3.363 | shared: anti, between, common, comprehensive, conceptual -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.3 INCLUDE LOD Patterns\INCLUDE for user-level metrics\README.md) <!-- score: 3.339 | shared: anti, application, common, comprehensive, conceptual -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.2 FIXED LOD Patterns\FIXED for baseline snapshots\README.md) <!-- score: 3.259 | shared: anti, between, common, comprehensive, conceptual -->
- [README.md](..\..\4.2 String Calculations\Detecting inconsistent casing\README.md) <!-- score: 3.252 | shared: anti, application, between, case, common -->
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.1 Tableau Relationships\Why relationships reduce duplication\README.md) <!-- score: 3.250 | shared: anti, between, common, comprehensive, conceptual -->
