...
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.1 LOD Foundations\INCLUDE mechanics\README.md) <!-- score: 3.147 | shared: anti, common, components, concepts, conceptual -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.3 INCLUDE LOD Patterns\INCLUDE for stacking calculations\README.md) <!-- score: 3.101 | shared: anti, application, common, complex, complexity -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.5 Nested LOD Constructions\Avoiding circular LOD logic\README.md) <!-- score: 3.084 | shared: anti, common, complex, complexity, conceptual -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.3 INCLUDE LOD Patterns\INCLUDE for cross-row comparisons\README.md) <!-- score: 3.069 | shared: across, anti, common, complex, components -->
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.2 Physical Joins\Extract-only joins\README.md) <!-- score: 3.060 | shared: across, anti, common, concepts, conceptual -->
