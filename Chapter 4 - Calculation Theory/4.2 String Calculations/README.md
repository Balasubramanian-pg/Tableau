...
- [README.md](Regex match process\README.md) <!-- score: 3.728 | shared: algorithm, algorithms, anti, cases, characters -->
- [README.md](Comparing string lengths\README.md) <!-- score: 3.674 | shared: algorithms, anti, cases, characters, common -->
- [README.md](Trimming whitespace\README.md) <!-- score: 3.575 | shared: anti, cases, characters, common, components -->
- [README.md](..\..\Chapter 2 - Data Connections & Modeling\2.2 Connecting to Databases\Case sensitivity issues\README.md) <!-- score: 3.536 | shared: algorithms, anti, cases, characters, common -->
- [README.md](Regex extraction\README.md) <!-- score: 3.446 | shared: anti, cases, characters, common, conceptual -->
