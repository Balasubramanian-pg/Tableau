...
- [README.md](..\..\..\Chapter 2 - Data Connections & Modeling\2.2 Connecting to Databases\Schema discovery\README.md) <!-- score: 3.425 | shared: algorithms, anti, common, concepts, conceptual -->
- [README.md](..\Detecting inconsistent casing\README.md) <!-- score: 3.353 | shared: anti, between, common, components, concepts -->
- [README.md](..\..\4.1 Calculation Syntax and Logic\Handling non-numeric results\README.md) <!-- score: 3.318 | shared: anti, common, components, concepts, conceptual -->
- [README.md](..\..\..\Chapter 2 - Data Connections & Modeling\2.1 Connecting to Files\Working with TSV\README.md) <!-- score: 3.313 | shared: anti, between, common, component, components -->
- [README.md](..\..\..\Chapter 2 - Data Connections & Modeling\2.1 Connecting to Files\Multi-sheet schema mismatches\README.md) <!-- score: 3.274 | shared: anti, between, common, components, conceptual -->
