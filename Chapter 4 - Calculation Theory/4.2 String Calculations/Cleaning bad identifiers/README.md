...
- [README.md](..\Normalizing text fields\README.md) <!-- score: 3.640 | shared: analysis, anti, cases, common, conceptual -->
- [README.md](..\..\4.1 Calculation Syntax and Logic\CASE type constraints\README.md) <!-- score: 3.621 | shared: analysis, anti, book, cases, common -->
- [README.md](..\..\..\Chapter 5 - Level of Detail Expressions\5.2 FIXED LOD Patterns\FIXED for row deduplication\README.md) <!-- score: 3.527 | shared: analysis, another, anti, common, components -->
...
- [README.md](..\Detecting inconsistent casing\README.md) <!-- score: 3.499 | shared: analysis, anti, common, components, concepts -->
