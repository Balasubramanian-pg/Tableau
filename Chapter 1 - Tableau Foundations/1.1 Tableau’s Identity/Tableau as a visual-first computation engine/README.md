...
- [README.md](..\How Tableau abstracts SQL for analysts\README.md) <!-- score: 3.397 | shared: aggregation, between, calculations, clause, context -->
- [README.md](..\Tableau’s evolutionary history\README.md) <!-- score: 3.089 | shared: aggregation, api, database, defined, engine -->
- [README.md](..\..\..\README.md) <!-- score: 2.294 | shared: aggregation, based, calculations, field, fields -->
- [1. Row Level Security.md](..\..\..\Chapter 10 - Server, Cloud and Administration\10.2 Server Administration\Content governance\1. Row Level Security.md) <!-- score: 2.219 | shared: based, database, defined, field, filters -->
- [1. RLS Via User Groups.md](..\..\..\Chapter 10 - Server, Cloud and Administration\10.2 Server Administration\Group-based access control\1. RLS Via User Groups.md) <!-- score: 2.132 | shared: based, dimension, field, filters, level -->
