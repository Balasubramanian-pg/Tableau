...
- [2. Drill Down.md](..\..\..\Roadmap\2. Drill Down.md) <!-- score: 2.444 | shared: action, actions, based, choose, create -->
- [README.md](..\Tableau’s evolutionary history\README.md) <!-- score: 2.411 | shared: analysis, into, modern, pulse, rather -->
- [README.md](..\How Tableau abstracts SQL for analysts\README.md) <!-- score: 2.342 | shared: allows, dimensions, filter, into, introduction -->
- [README.md](..\..\..\README.md) <!-- score: 2.081 | shared: actions, analysis, based, chart, dashboard -->
- [README.md](..\Tableau as a visual-first computation engine\README.md) <!-- score: 1.989 | shared: based, dimensions, into, pulse, specific -->
