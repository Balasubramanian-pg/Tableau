...
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.3 Unions\Dealing with missing fields in unions\README.md) <!-- score: 3.467 | shared: cases, common, components, conceptual, consistency -->
- [README.md](..\..\5.4 EXCLUDE LOD Patterns\Removing grain for aggregated KPIs\README.md) <!-- score: 3.399 | shared: applied, cases, common, components, conceptual -->
- [README.md](..\..\..\Chapter 4 - Calculation Theory\4.1 Calculation Syntax and Logic\CASE type constraints\README.md) <!-- score: 3.380 | shared: application, applied, cases, common, components -->
- [README.md](..\..\..\Chapter 4 - Calculation Theory\4.1 Calculation Syntax and Logic\Handling non-numeric results\README.md) <!-- score: 3.369 | shared: cases, common, components, conceptual, consistent -->
- [README.md](..\..\5.3 INCLUDE LOD Patterns\INCLUDE for distribution analysis\README.md) <!-- score: 3.352 | shared: application, applied, applying, cases, common -->
