...
- [README.md](..\..\..\Chapter 4 - Calculation Theory\4.1 Calculation Syntax and Logic\CASE type constraints\README.md) <!-- score: 3.667 | shared: anti, application, applied, case, cases -->
- [README.md](..\..\5.4 EXCLUDE LOD Patterns\Hierarchical EXCLUDE usage\README.md) <!-- score: 3.535 | shared: access, anti, application, applied, based -->
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.2 Physical Joins\Extract-only joins\README.md) <!-- score: 3.469 | shared: anti, cases, common, concepts, conceptual -->
- [README.md](..\..\..\Chapter 4 - Calculation Theory\4.1 Calculation Syntax and Logic\Boolean logic as filtering\README.md) <!-- score: 3.448 | shared: anti, applied, based, cases, common -->
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.1 Tableau Relationships\Relationship-generated queries\README.md) <!-- score: 3.436 | shared: anti, applied, based, cases, common -->
