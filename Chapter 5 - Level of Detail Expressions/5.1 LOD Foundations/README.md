...
- [README.md](LOD and filters\README.md) <!-- score: 3.739 | shared: aided, anti, cad, common, complex -->
- [README.md](LOD and blending\README.md) <!-- score: 3.534 | shared: anti, between, common, complexity, conceptual -->
- [README.md](LOD purpose\README.md) <!-- score: 3.367 | shared: anti, between, common, complex, complexity -->
- [README.md](..\5.5 Nested LOD Constructions\Avoiding circular LOD logic\README.md) <!-- score: 3.342 | shared: anti, common, complex, complexity, computer -->
- [README.md](LOD within relationships\README.md) <!-- score: 3.341 | shared: analysis, anti, application, between, common -->
