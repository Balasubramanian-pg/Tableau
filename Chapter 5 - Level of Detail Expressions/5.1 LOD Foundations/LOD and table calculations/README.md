...
- [README.md](..\How LODs bypass row-level grain\README.md) <!-- score: 3.734 | shared: aggregated, aggregation, analysis, anti, business -->
- [README.md](..\LOD purpose\README.md) <!-- score: 3.416 | shared: anti, cases, common, complex, comprehensive -->
- [README.md](..\LOD and filters\README.md) <!-- score: 3.411 | shared: anti, cases, common, complex, concepts -->
- [README.md](..\..\5.4 EXCLUDE LOD Patterns\Removing grain for aggregated KPIs\README.md) <!-- score: 3.399 | shared: aggregated, aggregation, anti, applied, business -->
- [README.md](..\..\5.3 INCLUDE LOD Patterns\INCLUDE for cross-row comparisons\README.md) <!-- score: 3.279 | shared: aggregation, analysis, anti, cases, common -->
