...
- [README.md](..\LOD and table calculations\README.md) <!-- score: 3.728 | shared: aggregated, aggregation, analysis, anti, business -->
- [README.md](..\..\5.3 INCLUDE LOD Patterns\INCLUDE for cross-row comparisons\README.md) <!-- score: 3.667 | shared: aggregation, analysis, anti, cases, common -->
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.2 Physical Joins\Extract-only joins\README.md) <!-- score: 3.612 | shared: anti, business, cases, common, conceptual -->
- [README.md](..\..\5.4 EXCLUDE LOD Patterns\Removing grain for aggregated KPIs\README.md) <!-- score: 3.543 | shared: aggregated, aggregation, anti, business, cases -->
- [README.md](..\..\5.3 INCLUDE LOD Patterns\INCLUDE with dimensions vs measures\README.md) <!-- score: 3.507 | shared: analysis, anti, business, common, components -->
