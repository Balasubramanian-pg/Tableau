...
- [README.md](..\..\5.1 LOD Foundations\EXCLUDE mechanics\README.md) <!-- score: 3.545 | shared: access, anti, application, applied, based -->
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.2 Physical Joins\Preventing Cartesian joins\README.md) <!-- score: 3.416 | shared: algorithms, anti, applying, book, cases -->
- [README.md](..\..\..\Chapter 2 - Data Connections & Modeling\2.2 Connecting to Databases\Materialized views in databases\README.md) <!-- score: 3.407 | shared: anti, based, book, cases, common -->
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.1 Tableau Relationships\Relationship-generated queries\README.md) <!-- score: 3.336 | shared: anti, applied, based, cases, common -->
- [README.md](..\..\..\Chapter 4 - Calculation Theory\4.3 Numerical Calculations\Rounding patterns\README.md) <!-- score: 3.302 | shared: algorithms, anti, application, applied, applying -->
