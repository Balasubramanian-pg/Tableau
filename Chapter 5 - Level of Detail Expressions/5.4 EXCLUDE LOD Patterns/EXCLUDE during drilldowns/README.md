...
- [README.md](..\..\5.1 LOD Foundations\EXCLUDE mechanics\README.md) <!-- score: 3.401 | shared: anti, application, applied, based, cases -->
- [README.md](..\..\..\Chapter 4 - Calculation Theory\4.1 Calculation Syntax and Logic\Boolean logic as filtering\README.md) <!-- score: 3.350 | shared: anti, applied, based, cases, common -->
- [README.md](..\EXCLUDE vs window average\README.md) <!-- score: 3.300 | shared: analysis, anti, application, applying, cases -->
- [README.md](..\..\..\Chapter 3 - Physical Layer and Logical Layer Modeling\3.2 Physical Joins\Multi-join conflict resolution\README.md) <!-- score: 3.252 | shared: analysis, anti, applied, based, cases -->
- [README.md](..\..\5.3 INCLUDE LOD Patterns\INCLUDE for distribution analysis\README.md) <!-- score: 3.251 | shared: analysis, anti, application, applied, applying -->
